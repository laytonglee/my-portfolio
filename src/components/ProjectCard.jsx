    ...
    >
      <div
        className={`rounded-2xl overflow-hidden border transition-all duration-500
          ${
            isDarkMode
              ? "bg-gray-900/0 border-gray-800 hover:border-gray-700 hover:shadow-xl hover:shadow-blue-500/10"
              : "bg-white/80 border-gray-200 hover:border-gray-300 hover:shadow-xl hover:shadow-blue-500/10"
          } backdrop-blur-sm`}
      >
        {/* Project Image */}
